...
//		this.playerRespawn();
	...
	chestOpening: function(player, chest) {
		if (this.input.keyboard.isDown(Phaser.Keyboard.TWO) || this.interact) {
			if(chest.isOpened == false) {
				...
				this.lightning.animations.play('lightningloop');//play lightning animation
	...
	addEnemy: function() {
		...
		switch (game.global.playLevel) {
			...
			this.lightning.animations.add('lightningloop', ['lightning_01', 'lightning_02', 'lightning_03', 'lightning_04'], 8, true);
			break;
